...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url() ?>/assets-home/dist/css/style.css">
...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        <header class="site-header">
            <div class="header-shape header-shape-1">
                ...
                <!-- <img src="https://ibb.co/Wv5xwy5" width="337" height="222" viewBox=" 0 0 337 222 "> -->
                <defs>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <!-- <a href="https://imgbb.com/"><img src="https://i.ibb.co/yFPf1yP/icon.png" width="70" height="70" alt="icon" border="0"></a> -->
                                <title>April</title>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Selamat Datang Di Perpustakaan Kota</h1>
                            <p class="hero-paragraph">sistem informasi ini dibuat untuk meningkatkan minat membaca buku, sehingga dengan adanya sistem ini pembaca bisa meminjam atau membaca buku di mana saja dan kapan saja.</p>
                            <div class="hero-form field field-grouped">
                                <!-- <div class="control control-expanded">
									<input class="input" type="email" name="email" placeholder="Silakan masukan email anda&hellip;">
								</div> -->
                                <div class="control">
                                    <a class="button button-primary button-block" href="home/login">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Buku</h2>
                                <p class="section-paragraph">Sistem informasi perpustakaan kota ini memiliki berbagai banyak buku yang dapat dibaca untuk semua kalangan</p>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Sejarah</h4>
                                    <p class="text-sm">Terdapat berbagai buku yang bertemakan sejarah dalam negri maupun luar negri.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Psikologi</h4>
                                    <p class="text-sm">Terdapat bermacam-macam buku yang bertemakan psikologi.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Agama</h4>
                                    <p class="text-sm">Terdapat berbagai macam buku yang bertemakan agama.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Bahasa</h4>
                                    <p class="text-sm">Terdapat berbagai buku tentang berbagai macam bahasa yang ada di dunia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="testimonials section">
                ...
                <div class="container">
                    <div class="testimonials-inner section-inner">
                        <h2 class="section-title mt-0 text-center">Menurut Mereka</h2>
                        <div class="testimonials-wrap">
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="<?php base_url(); ?>/assets-home/dist/images/testimonial-01.png" alt="Testimonial">
                                        </div>
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="<?php base_url(); ?>/assets-home/dist/images/testimonial-02.png" alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                        </div>
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="<?php base_url(); ?>/assets-home/dist/images/testimonial-03.png" alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                        </div>
    ...
    <script src="<?php base_url(); ?>/assets-home/dist/js/main.min.js"></script>
</body>
